...
/**
 * Kohana packages directory. This directory should contain all the packages used
 * by your application. Modules are enabled and disabled by the application
 * configuration file.
 *
 * This path can be absolute or relative to this file.
 */
$kohana_packages		= 'packages';
 ...
 */
version_compare(PHP_VERSION, '5.3', '<') and exit('This experimental version of Kohana requires PHP 5.3 or newer.');
...
// ----------------------------------------------------------------------------
// $Id: index.php 4741 2010-01-16 02:33:24Z isaiah $
//
...
$kohana_packages	= file_exists($kohana_packages) ? $kohana_packages : DOCROOT.$kohana_packages;
$kohana_system		= file_exists($kohana_system) ? $kohana_system : DOCROOT.$kohana_system;

// Define application and system paths
define('APPPATH', str_replace('\\', '/', realpath($kohana_application)).'/');
define('PKGPATH', str_replace('\\', '/', realpath($kohana_packages)).'/');
define('SYSPATH', str_replace('\\', '/', realpath($kohana_system)).'/');

// Clean up
unset($kohana_application, $kohana_packages, $kohana_system);
