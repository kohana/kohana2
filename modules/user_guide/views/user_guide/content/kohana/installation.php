...
4. Using a Text Editor, open the file <file>/application/config/config</file>
    ...
    * Examples:
		1. The sub directory *kohana* of the server named *localhost*<br />
<code>
$config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].'/kohana/';<br />
can be accessed via this url: http://localhost/kohana
</code>
		2. The *DOCUMENT ROOT* of the server named *example.com*<br />
<code>
$config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].'/';<br />
can be accessed via this url: http://example.com
</code>
5. Test your Installation
    * Open your favourite web browser and point it at the URL defined in *base_url*
	* Your should now be viewing the "Welcome page" of the Kohana User Guide, on your server


**Congratulations!** <br />
You can explore your new Kohana Framework by reading the User Guide, a good place
to start would be [Getting Started](<?php echo url::base().'user_guide/kohana/starting'?>)

## Experiencing Problems?
If you were not able to view the Kohana User Guide on your server after installing, we recommend
reading the [Toubleshooting](<?php echo url::base().'user_guide/troubleshoot'?>) page of the user 
guide for more help.
