...
<head>
	...
	<title><?php echo \Helper\html::chars(\Library\I18n::__($title)) ?></title>

	<style type="text/css">
	html { background: #83c018 url(<?php echo \Helper\url::base(FALSE) ?>kohana.png) 50% 0 no-repeat; }
...
<body>
	...
	<h1><?php echo \Helper\html::chars(\Library\I18n::__($title)) ?></h1>
	<?php echo $content ?>

	<p class="copyright">
		<?php echo \Library\I18n::__('Rendered in {execution_time} seconds, using {memory_usage} of memory')?><br />
