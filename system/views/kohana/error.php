<div class="kohana_error"><a href="#show_trace" id="kohana_error_trace_link_<?php echo $instance_identifier ?>"><?php echo $code ?></a>: <code><?php echo $error ?></code> [ <strong><?php echo $file ?></strong>, line <strong><?php echo $line ?></strong> ]</div>
