...
class utf8 {
	...
	{
		if (\Helper\text::is_ascii($str1) AND \Helper\text::is_ascii($str2))
	...
	{
		if (\Helper\text::is_ascii($search) AND \Helper\text::is_ascii($replace) AND \Helper\text::is_ascii($str))
	...
	{
		if (\Helper\text::is_ascii($str) AND \Helper\text::is_ascii($search))
	...
	public static function strspn($str, $mask, $offset = NULL, $length = NULL)
	{
		...
		if (\Helper\text::is_ascii($str) AND \Helper\text::is_ascii($mask))
	...
	{
		if (\Helper\text::is_ascii($str) AND \Helper\text::is_ascii($pad_str))
		{
	...
	public static function ltrim($str, $charlist = NULL)
	{
		...
		if (\Helper\text::is_ascii($charlist))
