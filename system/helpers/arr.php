...
class arr {
	 ...
	 *      );
	 *
	 *     echo \Kernel\Kohana::debug($optical_discs);
	 ...
	 *      echo \Kernel\Kohana::debug(arr::get($optical_discs, 'CD', 'Not-existent!'));
	 *      echo \Kernel\Kohana::debug(arr::get($optical_discs, 'BLRY', 'Non-existent!'));
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
	 ...
	 *      echo \Kernel\Kohana::debug($fruits);
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
	 ...
	 *      }
	 *
	 *      echo \Kernel\Kohana::debug(arr::map_recursive(array($this, 'plus_one'), array('a' => 1, 'b' => 2, 'c' => array(3, 4), 'd' => array('e' => 5))));
	 *
	 *      // Or, you can use the lambda function syntax of PHP 5.3
	 *      echo \Kernel\Kohana::debug(arr::map_recursive(function($value){return $value+1;}, array('a' => 1, 'b' => 2, 'c' => array(3, 4), 'd' => array('e' => 5))));
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
	 ...
	 * ##### Example
	 *
	 *      echo \Kernel\Kohana::debug(arr::merge(array('a', 'b'), array('c', 'd'), array('e' => array('f', 'g'))));
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
	 ...
	 *      echo \Kernel\Kohana::debug(arr::overwrite($array1, $array2));
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
	 ...
	 *      echo $array ->test;
	 *      echo \Kernel\Kohana::debug($array);
	 *
	 *      // Output:
	 *      13
	 ...
	 *      echo \Kernel\Kohana::debug(arr::pluck('one', $arr1));
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
	 ...
	 *      // Returning the slice
	 *      echo \Kernel\Kohana::debug(arr::slice($arr1, 0, 2));
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
	 ...
	 *      echo \Kernel\Kohana::debug(arr::slice($arr2, 2, 2));
	 *
	 *      // Output:
	 *      (array) Array
	 *      (
