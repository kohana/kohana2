 ...
 *     else
 *     {
 *         echo \Kernel\Kohana::debug($data->errors());
 *     }
 *
...
class valid {
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::email($email));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *     $email = 'bill@gates.com';
	 *
	 *     \Kernel\Kohana::debug(valid::email_domain($email));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *     $email = 'bill@gates.com';
	 *
	 *     \Kernel\Kohana::debug(valid::email_rfc($email));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::url($url));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::ip($ip_address));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::credit_card($cc_num, array('visa', 'mastercard')));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	...
	public static function credit_card($number, $type = NULL)
	{
		...
		$cards = \Kernel\Kohana::config('credit_cards');
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::phone($phone_number));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *     $date = '12/12/12';
	 *
	 *     \Kernel\Kohana::debug(valid::date($date));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::alpha($str));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::alpha_numeric($str));
	 *
	 *     // Output:
	 *     (boolean) false
	 *
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::alpha_dash($str));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *
	 *     \Kernel\Kohana::debug(valid::alpha_space($str));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *     $str = '23';
	 *
	 *     \Kernel\Kohana::debug(valid::digit('23'));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 * ###### Example:
	 *
	 *     \Kernel\Kohana::debug(valid::numeric('2.3'));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 *     $num = '5';
	 *
	 *     \Kernel\Kohana::debug(valid::range('5', array(1, 10)));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 * ###### Example:
	 *
	 *     \Kernel\Kohana::debug(valid::decimal('4.5', array(2,1)));
	 *
	 *     // Output:
	 *     (boolean) false
	 *
	 ...
	 * ###### Example:
	 *
	 *     \Kernel\Kohana::debug(valid::color('#CCCCCC));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
	 ...
	 * ###### Example:
	 *
	 *     \Kernel\Kohana::debug(valid::multiple(200, 50));
	 *
	 *     // Output:
	 *     (boolean) true
	 *
