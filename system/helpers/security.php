 ...
 *     echo \Kernel\Kohana::debug(security::xss_clean("'';!--\"<XSS>=&{()}"));
 *     
 *     // Output:
 *     (string) &#039;&#039;;!--&quot;&lt;XSS&gt;=&amp;{()}
 *
...
class security {
	 ...
	 *     echo \Kernel\Kohana::debug(security::xss_clean("'';!--\"<XSS>=&{()}", 'htmlpurifier'));
	 *     
	 *     // Output:
	 *     (string) &#039;&#039;;!--&quot;&lt;XSS&gt;=&amp;{()}
	 *
	...
	{
		return \Library\Input::instance()->xss_clean($str, $tool);
	}
	 ...
	 * ###### Example
	 *
	 *     echo \Kernel\Kohana::debug(security::strip_image_tags('<image src="rambo-kitteh.png" alt="Rambo Kitteh!" />'));
	 *     
	 *     // Output:
