 ...
 *
 *     echo \Kernel\Kohana::debug(form::dropdown('year', date::years()));
 *
...
class date {
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::unix2dos(mktime(0, 0, 0, 31, 10, 1987)));
	 *
	 *     // Output:
	 *     (integer) 317325312
	 *
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::dos2unix(317325312));
	 *
	 *     // Output:
	 *     (integer) 616046400
	 *
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::offset('EST', 'PST'));
	 *
	 *     // Output:
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::seconds(30));
	 *
	 *     // Output:
	 *     (array) Array
	 *     (
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::minutes(30));
	 *
	 *     // Output:
	 *     (array) Array
	 *     (
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::hours(3));
	 *
	 *     // Output:
	 *     (array) Array
	 *     (
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::ampm(1));
	 *     echo \Kernel\Kohana::debug(date::ampm(date('G')));
	 *
	 *     // Output:
	 *     (string) AM
	 *     (string) PM
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::adjust(2, 'am'));
	 *     echo \Kernel\Kohana::debug(date::adjust(2, 'pm'));
	 *
	 *     // Output:
	 *     (string) 02
	 *     (string) 14
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::days(2, 2010));
	 *     echo \Kernel\Kohana::debug(date::days(3, 2010));
	 *
	 *     // Output (output has been truncated for display purposes):
	 *     (array) Array
	 *     (
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::months());
	 *
	 *     // Output (output has been truncated for display purposes):
	 *     (array) Array
	 *     (
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::years());
	 *
	 *     // Output (output has been truncated for display purposes):
	 *     (array) Array
	 *     (
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::timespan(time(), strtotime('2 year ago')));
	 *
	 *     // Output:
	 *     (array) Array
	 *     (
	 ...
	 * ##### Example
	 *
	 *     echo \Kernel\Kohana::debug(date::timespan_string(time(), strtotime('2 year ago')));
	 *
	 *     // Output:
