...
class Core_Calendar {
	 ...
	 * @access	public
	 */
	function Core_Calendar($config = array())
	{
		$this->CORE =& get_instance();

		if ( ! in_array('calendar_lang'.EXT, $this->CORE->lang->is_loaded, TRUE))
		{
			$this->CORE->lang->load('calendar');
		}
	...
	function get_month_name($month)
	{
		...
		if ($this->CORE->lang->line($month) === FALSE)
		{
			return ucfirst(str_replace('cal_', '', $month));
		}

		return $this->CORE->lang->line($month);
	}
	...
	function get_day_names($day_type = '')
	{
		...
		{
			$days[] = ($this->CORE->lang->line('cal_'.$val) === FALSE) ? ucfirst($val) : $this->CORE->lang->line('cal_'.$val);
		}
