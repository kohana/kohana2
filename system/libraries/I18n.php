...
class I18n {
	...
	public static function get_locale($ext = true)
	{
		if($ext)
			...
			return \Helper\arr::get(explode('.', I18n::$locale), 0);
	}
	...
	public static function get_text($string)
	{
		if ( ! I18n::$translations)
		{
			...
			$translation_files = \Kernel\Kohana::find_file('i18n', $locale[0]);

			if($local_translation_files = \Kernel\Kohana::find_file('i18n', $locale[0].'/'.$locale[1]))
