 ...
 * between different pagination settings used for different website sections.
 ...
 *  clean_url_page1 - Hides pagination variables in the URL when linking to the first page
 */
