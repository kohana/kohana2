...
(
	...
	'invalid_filetype'      => 'El tipo de fichero solicitado, <tt>.%s</tt>, no esta permitido en el fichero de configuración de tus vistas.',
	...
	'error_message'         => 'Ocurrio un error en la <strong>linea %s</strong> de <strong>%s</strong>.'
