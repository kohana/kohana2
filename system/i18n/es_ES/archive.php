...
$lang = array
(
	'driver_not_supported' => 'El driver requerido, %s, no esta soportado.',
	'driver_implements'    => 'El driver requerido, %s, no implementa los metodos requeridos por la interface Archive_Driver.',
