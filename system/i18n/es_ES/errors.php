...
(
	...
	E_DATABASE_ERROR     => array( 1, 'Error de Base de Datos',    'Ocurrio un error en la base de datos mientras se ejecutaba el procedimiento requerido. Para más información, revisa el error que aparece más abajo.'),
