...
(
	...
	'no_default_route'      => 'Подете ја default рутата во <tt>config/routes.php</tt>.',
	...
	'stats_footer'          => 'Вчитано за {execution_time} секунди, употребено {memory_usage} меморија. Креирано со Kohana в{kohana_version}.',
