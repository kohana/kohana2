...
$lang = array
(
	E_KOHANA             => array( 1, 'Framework Error',   'Проверете во документацијата на Kohana во врска со оваа грешка.'),
	E_PAGE_NOT_FOUND     => array( 1, 'Page Not Found',    'Страната не е пронајдена. Можеби е преместена, избришена или архивирана.'),
