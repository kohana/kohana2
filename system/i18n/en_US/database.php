...
(
	...
	'driver_not_supported'  => 'The %s database driver does not exist.',
	...
	'must_use_table'        => 'You must set a datbase table for your query.',
	'not_implimented'       => 'The method you called, %s, is not supported by this driver.'
);