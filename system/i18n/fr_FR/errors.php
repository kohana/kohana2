...
(
	...
	E_DATABASE_ERROR     => array( 1, 'Database Error',    'Une erreur de base de données est survenue lors de la procédure de requête. Veuillez vous référer à l\'erreur renvoyée ci-dessous pour plus d\'informations.'),
