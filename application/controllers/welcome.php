...
class Welcome extends \Controller\Template {
	...
	public function __call($method, $arguments)
	{
		...
		echo \Library\I18n::__('This text is generated by __call. If you expected the index page, you need to use: :uri:',
				array(':uri:' => 'welcome/index/'.substr(\Library\Router::$current_uri, 8)));
	}
