...
<p id="donate">If you use Kohana and find it worth something, please consider <strong><?php echo html::anchor('donate', 'donating') ?></strong>. <?php echo html::anchor('donation_list', 'Your donations') ?> will be directly used to cover the costs of maintaining Kohana.</li>
</p>
