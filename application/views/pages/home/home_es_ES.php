...
<ol>
	...
	<li><strong>Los <a href="http://upload.wikimedia.org/wikipedia/en/1/1c/Kohana-modules.png">recursos en cascada</a> ofrecen una extensibilidad sin precedentes.</strong> Cada una de las partes de Kohana puede ser sustituida o extendida sin editar ningun fichero del sistema base. El sistema de Módulos permite añadir extensiones con múltiples ficheros de manera transparente.</li>
