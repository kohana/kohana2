...
<div style="float:left;">
	...
	<ul>
		...
		<li>Système à base d'événement très puissant facilitant les modifications</li>
...
<ol>
	<li><strong>Projet communautaire et non lié à une compagnie.</strong> Le développement de Kohana est conduit par une équipe de gens motivés ayant besoin Kd'un framework pour rapidement construire des applications puissantes.</li>
	<li><strong>Programmation <abbr title="Object Oriented Programming">OOP</abbr> PHP 5 Stricte.</strong> Offre de nombreux avantages: protéction de la visibilité, chargement automatique de classes, surcharge, interfaces, abstraction et singletons.</li>
	<li><strong>Très léger.</strong> Kohana n'a aucune dépendances par rapport aux extensions PECL ou aux librairies PEAR. Les librairies volumineuse et monolithiques sont évitées au profit de solutions optimisées.</li>
	...
	<li><strong>Pas de conflits de nommage.</strong> Toutes les classes sont suffixés pour permettre des noms similaire entre les composants et ainsi obtenir une API plus cohérente.</li>
	<li><strong>Extension grâce aux chargement en cascade des ressources.</strong> Preque toutes les parties de Kohana peuvent être surchargés ou étendues sans éditer le coeur du système. Les modules permettent l'ajout de plugins comprenant de multiples fichiers de façon transparente.</li>
	...
	<li><strong>Système d'évenement puissant.</strong> un support des événements inspiré du design pattern Observer offre un niveau de personnalisation extrême.</li>
