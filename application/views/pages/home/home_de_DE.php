<p class="intro">Kohana ist ein <strong>PHP-5-Framework</strong>, bei dem die <strong>Model-View-Controller</strong>-Architektur zum Einsatz. Ziel ist es <strong>sicher</strong>, <strong>schlank</strong> und <strong>leicht bedienbar</strong> zu sein.</p>
...
<ol>
	...
	<li><strong>Kaskadierte Ressourcen erlauben einmalige Erweiterbarkeit.</strong> Nahezu jeder Bestandteil in Kohana kann überladen oder erweitert werden, ohne System-Dateien bearbeiten zu müssen. Module erlauben es Plugins mit mehreren Dateien zu Ihrer Applikation transparent hinzuzufügen.</li>
