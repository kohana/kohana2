...
<ol>
	...
	<li><strong>Estremamente leggero.</strong> Kohana non ha alcuna dipendenza da estensioni PECL extensions o librerie PEAR. È stato evitato l'uso di librerie monolitiche a favore di soluzioni ottimizzate.</li>
	...
	<li><strong>Caricamento automatico delle classi.</strong> Il caricamento delle classi avviene nel momento in lo necessita l'applicazione.</li>
	...
	<li><strong>Potente gestione degli eventi.</strong> Il sistema di gestione degli eventi incorpora una struttura di tipo <em>Observer</em>, il quale permette un estremo livello di personalizzazione sulla gestione degli eventi, potenzialmente senza limiti.</li>
