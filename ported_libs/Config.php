...
class Core_Config {
	...
	public function __construct()
	{
		...
		Log::add('debug', 'Config Class Initialized');
	}
	 ...
	 * @return void
	 */
	private function _set_search_paths()
	{
		global $CPATHS;
	...
	public function load($file = '', $use_sections = FALSE, $fail_gracefully = FALSE)
	{
		...
		else
		{
			if ($fail_gracefully === TRUE)
			{
				Log::add('error', 'The configuration file '.$file.EXT.' does not exist in the search paths.');
				return FALSE;
			}
			
			show_error('The configuration file '.$file.EXT.' does not exist in the search paths.');
		}
		Log::add('debug', 'Config file loaded: config/'.$file.EXT);
		return TRUE;
	}
